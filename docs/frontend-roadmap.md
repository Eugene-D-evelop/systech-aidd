...
| 4 | F04 | Реализация AI-чата для администратора | ✅ Завершен (2025-10-17) | Полноценный веб-чат с floating button, Normal и Admin режимами. Text2Postgre pipeline для вопросов по статистике. ChatManager с LLM интеграцией, история в БД. Responsive UI, 5 компонентов чата. Real API для статистики включен. | [План](../.cursor/plans/sprint-f04-dashboard.md) |
| 5 | F05 | Расширенная аналитика | 📋 Запланирован | Дополнительные метрики и визуализации, экспорт данных, расширенные фильтры | - |
...
📚 [Референс компонента чата от 21st.dev](../frontend/doc/references/21st-ai-chat.md)
