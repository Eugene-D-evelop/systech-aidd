...
- ✅ **PostgreSQL** - постоянное хранение истории диалогов
...
- `/role` - **✨ НОВОЕ** Отображение роли и специализации бота
...
- **PostgreSQL** - история диалогов сохраняется в базе данных (до 10 сообщений по умолчанию)
- **Persistence** - история сохраняется при перезапуске бота
...
- ✅ **Tests**: 61 тест (48 юнит + 13 интеграционных)
- ✅ **Coverage**: 69% (100% для ключевых модулей)
...
Проект использует PostgreSQL для хранения истории сообщений:
